...
export function Footer() {
  return (
    <footer className="relative z-20 border-t border-purple-500/20 py-16 text-white bg-[#07050e] backdrop-blur-xl pointer-events-auto">
      <div className="container mx-auto px-4 md:px-6 space-y-10 max-w-6xl">
        
        {/* Brand & Tagline Header */}
        <div className="text-center space-y-3">
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white">
            <span>iSkylar™ — Therapy, </span>
            <span className="text-sky-400">Evolved.</span>
          </h2>
