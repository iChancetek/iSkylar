...
## Core Features
- **AI-Powered Voice Companions:** Real-time, empathetic interaction powered by OpenAI `gpt-5.4-mini`.
...
- **Core Model**: The system relies on OpenAI's `gpt-5.4-mini` via direct API calls for the primary conversational loop, optimizing for ultra-low latency and highly natural response flow.
