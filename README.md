...
- **Core Model**: The system relies on OpenAI's `gpt-5.6-terra` (primary) and `gpt-5.4-mini` (fallback) via direct API calls for the primary conversational loop, optimizing for ultra-low latency and highly natural response flow.
